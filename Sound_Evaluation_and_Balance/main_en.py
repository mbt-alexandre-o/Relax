...
class FirstFrame(ttk.Frame):
    ...
    def __init__(self, app):
        ...
        label = ttk.Label(self,anchor=tk.CENTER,text="Thank you for participating to this experiment.\n\nYou will be asked to listen to X soundscapes and to give your opinion on them.")
        label.place(relx = 0.2,rely=0.2,relwidth=0.65,relheight=0.45)

        self.next_button = tk.Button(self,text="Next", command=self.stop)
...
class VolumeFrame(ttk.Frame):
    ...
    def __init__(self, app,file):
        ...
        self.volume_scale = Eva(
            self,
            "Please, use the slider to set the volume of the sound.\n\nIt must be clearly audible yet comfortable.\n\nYou should hear droplets, wind in a cave, and a small stream.\n\nPlease make sure the sound volume suits you by listening it for at least 15sc after setting it.\n\n",
            "Low",
            "High",
            to_= 1,
            set_= 0,
        ...
        self.stop_button = tk.Button(self,text="Start the first Soundscape",command=self.stop)
...
class SoundScapeSurveyRatingFrame(ttk.Frame):
    ...
    def __init__(self, app, file):
        ...
        self.relaxation = Eva(self,"How relaxing did you find this soundscape?","Not relaxing at all","Very relaxing")
        self.relaxation.place(relx=0.2,rely=0.4,relwidth=0.6)

        self.interest = Eva(self,"How interesting did you find this soundscape?","Boring","Very interesting")
...
class SoundScapeSurveyQuestionFrame(ttk.Frame):
    ...
    def __init__(self, app, file):
        ...
        self.question_1 = Question(self,"Did the soundscape evoke a mental image? If so, can you tell us which one(s) ?",number_row=5)
        self.question_1.place(relx=0.2,rely=0.15,relwidth=0.6) 

        self.question_2 = Question(self,"What are the different sounds composing the soundscape you could identify ?",number_row=5)
        self.question_2.place(relx=0.2,rely=0.4,relwidth=0.6) 

        self.question_3 = Question(self,"Do you have any suggestion to improve the soundscape?\n(more pleasant, relaxing, interesting)?",number_row=5)
...
class SoundscapeVolumeFrame(ttk.Frame):
    ...
    def __init__(self, app,dir):
        ...
        self.volume_2 = 0.5
        self.volume_3 = 0.5
        info = json.load(open(dir+'info_en.json'))
        
        label = ttk.Label(self,anchor=tk.CENTER,text="Select the volume of the different elements.\nYou must be able to distinctly hear all three elements and their volume should be balanced.\n\nNB: The names of sound displayed are indications and might differ from your own perception.\nThis does not impact the result.")
        label.place(relx = 0.2,rely=0.1,relwidth=0.6,relheight=0.2)

        self.volume_scale_1 = Eva(
            self,
            f"Please, select the volume of the '{info['cardiac']}'.",
            "Low",
            "High",
            to_= 1.0,
            set_= 0.5,
        ...
        self.volume_scale_2 = Eva(
            self,
            f"Please, select the volume of the '{info['resp']}'.",
            "Low",
            "High",
            to_= 1.0,
            set_= 0.5,
        ...
        self.volume_scale_3 = Eva(
            self,
            f"Please, select the volume of the '{info['gastric']}'.",
            "Low",
            "High",
            to_= 1.0,
            set_= 0.5,
...
class IntermediateFrame(ttk.Frame):
    ...
    def __init__(self, app):
        ...
        label = ttk.Label(self,anchor=tk.CENTER,text="Well done.\n\nWhen you are ready to start the next soundscape, click on the 'Next' button.")
        label.place(relx = 0.2,rely=0.2,relwidth=0.65,relheight=0.45)

        self.next_button = tk.Button(self,text="Next soundscape", command=self.stop)
        self.next_button.place(relx=0.70,rely=0.85,relwidth=0.25,relheight=0.05) 
...
class LastFrame(ttk.Frame):
    ...
    def __init__(self, app):
        ...
        label = ttk.Label(self,anchor=tk.CENTER,text="The experiment is over.\nThank you again for your help.")
        label.place(relx = 0.2,rely=0.2,relwidth=0.6,relheight=0.6)

        self.stop_button = tk.Button(self,text="Finish",command=self.stop)
        self.stop_button.place(relx=0.70,rely=0.85,relwidth=0.25,relheight=0.05) 
