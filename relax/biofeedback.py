...
from egg_feedback import egg_feedback
from resp_feedback import resp_feedback
from ecg_feedback import ecg_feedback
import click
import keyboard
import numpy as np
import serial
...
class Biofeedback:
    ...
    def __init__(
        ...
        self.ft_resp = FieldTrip.Client()
        self.ft_ecg = FieldTrip.Client()
        self.ft_egg = FieldTrip.Client()
...
@click.command()
@click.option("--state", prompt="State",type=click.Choice(['egg', 'ecg','resp','moc'], case_sensitive=False))
